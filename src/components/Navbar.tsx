          ...
          <AnimatePresence>
            {isMenuOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: 8, scale: 0.95 }}
                transition={{ duration: 0.2, ease: "easeOut" }}
                className="absolute right-0 top-full mt-3 w-64 rounded-2xl border border-white/10 bg-[#121212] p-2 shadow-2xl origin-top-right overflow-hidden backdrop-blur-3xl z-50"
              >
                <div className="px-4 py-3 border-b border-white/5 mb-2">
